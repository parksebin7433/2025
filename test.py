...
# 색상 팔레트 예시 (간단히 – 필요 시 계속 확장 가능)
outfit_palette = {
    "봄": {
        "러블리": {
            "핑크": {"하의": ["화이트", "베이지"], "신발": ["화이트", "핑크"], "가방": ["화이트", "그레이"]},
            "화이트": {"하의": ["핑크", "데님 블루"], "신발": ["화이트", "베이지"], "가방": ["핑크", "화이트"]},
        },
        "섹시": {
            "빨강": {"하의": ["블랙", "화이트"], "신발": ["블랙", "실버"], "가방": ["블랙", "화이트"]},
            "검정": {"하의": ["화이트", "레드"], "신발": ["블랙", "레드"], "가방": ["실버", "블랙"]},
        },
        "캐주얼": {
            "화이트": {"하의": ["데님 블루", "베이지"], "신발": ["화이트", "핑크"], "가방": ["브라운", "화이트"]},
            "노랑": {"하의": ["화이트", "네이비"], "신발": ["화이트", "베이지"], "가방": ["화이트", "브라운"]},
        },
        "포멀": {
...
# ---------------------- 앱 시작 ----------------------
st.title("👗 패션 코디 추천 앱")
st.write("계절과 스타일, 그리고 상의 색을 선택하면 **3세트 코디 + 컬러 심리 & 스타일 설명**을 보여드려요!")
...
if st.button("✨ 코디 추천받기"):
    ...
    # 색상 심리 & 스타일 설명
    st.info(f"🎨 **컬러 심리:** {color_psychology[selected_top]}")
    st.success(f"👠 **스타일 특징:** {style_descriptions[style]}")
